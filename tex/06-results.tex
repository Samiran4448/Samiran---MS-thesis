...
Figure \ref{fig:gpu_comp} gives a comparison in runtimes across all graphs and queries on a logarithmic scale.
...
Queries in the family pyramids, fans, and wheels have higher speedups as compared to others.
...
Data graphs cit-patents and com-orkut perform worse than the baseline because the inducing subgraph kernel has high load imbalance.
